...
CREATE TABLE LOGRO(
	...
	icono_logro VARBINARY(MAX) NOT NULL,
...
CREATE TABLE CATEGORIA(
	cod_cat INTEGER IDENTITY(1, 1) PRIMARY KEY,
	nom_cat VARCHAR(100) UNIQUE NOT NULL,
	descr_cat VARCHAR(200) NOT NULL,
	imagen_repr VARBINARY(MAX) NOT NULL,
...
CREATE TABLE INTERCAMBIO(
	...
	cant_prod INTEGER,
	unidad_medida VARCHAR(20),
	foto_inter VARBINARY(MAX) NOT NULL,
...
CREATE TABLE ESCROW(
  id_escrow INTEGER IDENTITY(1,1) PRIMARY KEY,
