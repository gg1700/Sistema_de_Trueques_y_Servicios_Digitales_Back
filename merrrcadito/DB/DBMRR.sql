...
CREATE TABLE DETALLE_USUARIO(
    ...
    calif_us DECIMAL(2, 1) NOT NULL DEFAULT 0.0,
...
ALTER TABLE UBICACION ADD COLUMN id_us INTEGER;
ALTER TABLE UBICACION ADD FOREIGN KEY (id_us) REFERENCES USUARIO(id_us);
