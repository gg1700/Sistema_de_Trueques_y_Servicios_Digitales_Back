-- Stored Procedure: Solo agregar id_token al SP original sin tocar otros campos
-- Ejecuta este query primero para ver la estructura actual:
-- SELECT * FROM sp_obtenerhistorialtransaccionesusuario(18) LIMIT 1;

-- Luego ejecuta este para agregar id_token:
