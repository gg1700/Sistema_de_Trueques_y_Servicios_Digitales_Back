...
-- Descripción:
-- Esta función retorna todos los eventos creados por un usuario específico.
-- Se obtienen los eventos donde el usuario está registrado en USUARIO_EVENTO.
-- Devuelve información completa del evento incluyendo título, descripción, fechas, banner, etc.
