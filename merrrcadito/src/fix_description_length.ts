...
async function main() {
    try {
        console.log("Iniciando corrección de longitud de descripción...");

        // 1. Modificar la tabla EVENTO (YA SE EJECUTÓ, COMENTADO PARA EVITAR ERRORES)
        // console.log("Alterando tabla EVENTO: descripcion_evento -> TEXT...");
        // await prisma.$executeRaw`ALTER TABLE EVENTO ALTER COLUMN descripcion_evento TYPE TEXT;`;
        // console.log("Tabla EVENTO modificada.");

        // 2. Actualizar sp_registrarEvento
        console.log("Actualizando sp_registrarEvento para aceptar TEXT...");
    ...
    `;
        ...
        // 3. Actualizar sp_obtenerEventosPropiosUsuario
        console.log("Eliminando versión anterior de sp_obtenerEventosPropiosUsuario...");
        await prisma.$executeRaw`DROP FUNCTION IF EXISTS sp_obtenerEventosPropiosUsuario(integer);`;

        console.log("Creando sp_obtenerEventosPropiosUsuario con retorno TEXT...");
        await prisma.$executeRaw`
